...
export const careers: Career[] = [
  {
    ...
    startingAttributes: { safety: 65, skill: 55, finance: 55, network: 35 },
    icon: '💻',
  ...
  },
  {
    ...
    startingAttributes: { safety: 60, skill: 50, finance: 40, network: 50 },
    icon: '🎨',
    scenes: ['office', 'creative_studio', 'universal'],
    talents: [{
  ...
  },
  {
    ...
    startingAttributes: { safety: 80, skill: 40, finance: 35, network: 50 },
    icon: '📚',
  ...
  },
  {
    ...
    startingAttributes: { safety: 85, skill: 50, finance: 60, network: 40 },
    icon: '🩺',
    scenes: ['hospital', 'universal'],
    talents: [{
      id: 'analytical_mind',
  ...
  },
  {
    ...
    startingAttributes: { safety: 55, skill: 45, finance: 30, network: 65 },
    icon: '✍️',
    scenes: ['creative_studio', 'universal'],
    talents: [{
      id: 'audience_sense',
